...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { description: @bike.description, duration: @bike.duration, image_url: @bike.image_url, price: @bike.price, title: @bike.title } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { description: @bike.description, duration: @bike.duration, image_url: @bike.image_url, price: @bike.price, title: @bike.title } }
